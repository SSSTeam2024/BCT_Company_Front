...
const Transactions = () => {
  document.title = "Claim Management | Company Administration";
    ...
    () => [
      {
        ...
        accessor: (cellProps: any) => {
          switch (cellProps.type) {
            case "up":
              return (
                <i className="bx bx-trending-up align-middle text-success" />
              );
            case "down":
              return (
                <i className="bx bx-trending-down align-middle text-danger" />
              );
            default:
              return (
                <i className="bx bx-trending-up align-middle text-success" />
      ...
      },
      {
        ...
        accessor: (cellProps: any) => {
          return (
            <Link
              to="#"
              className="link-dark text-decoration-underline view-item-btn"
  ...
  const [modal_AddTransactionsModals, setmodal_AddTransactionsModals] =
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
                  ...
                  <Row className="gy-3">
                    ...
                    <Col xxl={3}>
                      <div className="hstack gap-2">
                        ...
                        <Button
                          variant="primary"
                          onClick={() => tog_AddTransactionsModals()}
                          className="w-100"
                        >
                  ...
                  <div className="noresult" style={{ display: "none" }}>
                    <div className="text-center py-4">
                      ...
                      <p className="text-muted mb-0">
                        We've searched more than 150+ transactions We did not
                        find any transactions for you search.
                      </p>
                    </div>
                  </div>
                  {/* </div> */}
                    ...
                    <table className="table table-borderless align-middle">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            <span className="fw-semibold">
                              {paymentDetails.cleintEmail ||
                                "this is a Claim response"}
                            </span>
                          </td>
                        </tr>
                        {/* <tr>
          ...
          <Modal
            show={modal_AddTransactionsModals}
            size="lg"
            onHide={() => {
              tog_AddTransactionsModals();
            }}
            className="zoomIn"
            centered
          >
            ...
            <Modal.Body className="p-4">
              <Form className="tablelist-form">
                <Row>
                  ...
                  <Col lg={6}>
                    <div className="mb-3">
                      <Form.Label htmlFor="transactionDate-field">
                        Date
                      </Form.Label>
                      <Flatpickr
                        className="form-control flatpickr-input"
